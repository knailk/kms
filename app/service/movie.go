...
type MovieServicer interface {
	Create(ctx context.Context, r *CreateMovieRequest, adt entity.Audit) (*MovieResponse, error)
	Update(ctx context.Context, r *UpdateMovieRequest, adt entity.Audit) (*MovieResponse, error)
